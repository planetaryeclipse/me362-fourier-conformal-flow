function [fin_z_pos] = create_linear_french_curve_fin_profile(L_f, L_fl, h_f, curve_res)

L_fl = L_f; % Forces equivalence
...
top_fin_preceding = h_f/L_fl.*(fin_preceding_domain-fin_start);
...
fin_trail_curve_top =-1.5.*sqrt(fin_trail_curve_domain - fin_trail_curve_start) +h_f ;
