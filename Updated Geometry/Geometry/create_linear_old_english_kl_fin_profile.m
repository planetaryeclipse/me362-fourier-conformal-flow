function [fin_z_pos] = create_linear_old_english_kl_fin_profile(L_f, L_fl, h_f, curve_res)
...
top_fin_preceding = h_f/L_f.*((fin_preceding_domain-fin_start));
...
fin_trail_curve_top = linsh_c = 1.5; % Forward cap heightpace(h_f,0, curve_res);
